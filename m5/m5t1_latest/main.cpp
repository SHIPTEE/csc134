...
void choice_go_home() { cout << "RUN AS FAST AS YOU CAN" << endl; }

void print_game_over() { cout << "******** GAME OVER ********" << endl; }
...
void choice_kick_door() {
  ...
  cout << "BEWARE!!! The zombies inside respond to loud noises. BEWARE!!!"
       << endl;
...
void choice_kick_door_again() {
  ...
  cout << "You kick the door in." << endl;
  cout << "You manage to knock out a zombie. Awesome! Now leave before you're "
          "eaten."
       << endl;
}
